...
namespace Composite
{
    ...
    class Employee : IPerson, IEnumerable<IPerson>
    {
        ...
        public void AddSuborditanes(IPerson person)
        {
            _subordinates.Add(person);
        }
        public void RomeveSuborditane(IPerson person)
        {
